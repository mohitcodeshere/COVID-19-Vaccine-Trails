<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VolunteerLogin.aspx.cs" Inherits="VolunteerLogin" %>
        ...
        <table style="width: 375px">
            <tr>
                <td align="center" colspan="2" style="font-weight: bold; font-size: 14pt; color: #ffffff;
                                        background-color: gray">Volunteer login</td>
                <td align="center" colspan="1" rowspan="4" valign="middle">
                    <asp:Image ID="Image1" runat="server" Height="117px" ImageAlign="AbsMiddle" ImageUrl="~/Images/webconlo.gif" Width="104px" />
                </td>
            </tr>
            <tr>
