<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SeekerRegistration.aspx.cs" Inherits="SeekerRegistration" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"><div style="font-family: Arial; font-size: large; font-weight: 100; font-style: normal; font-variant: normal; background-color: #C0C0C0"><p style="margin-left: 160px">
        &nbsp;</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p style="margin-left: 40px">
        &nbsp;</p>
    <p style="margin-left: 40px">
        Total Years of Establishment&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="age" runat="server"></asp:TextBox>
    </p>
    <p style="margin-left: 40px">
        &nbsp;</p>
    <p style="margin-left: 40px; color: #FF3300;">
        Hospital Head - Details</p>
    <p style="margin-left: 40px">
        Mobile No&nbsp;(Director)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p style="margin-left: 40px">
        Gender&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:RadioButtonList ID="gender" runat="server" Width="135px">
        </asp:RadioButtonList>
&nbsp;&nbsp;</p>
    <p style="margin-left: 40px">
